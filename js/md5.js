/* Minimal MD5 (RFC 1321) implementation, no dependencies.
   Used only to gate /admin behind a client-side password check.
   NOTE: this is a UX deterrent, not real access control — every file
   this page can fetch is a public static file, hash included. */
(function (window) {
  const K = [
  ...
  function md5(str) {
    ...
    const bitLenLow = bitLen % 4294967296;
